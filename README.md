...
services:  # Define the services (containers) you want to run.
    ...
    database:  # Define a service named "database."
        build:  # Build the Docker image for this service.
          ...
          dockerfile: Dockerfile  # Specify the Dockerfile to use for building the image.
        container_name: databasetp  # Set the name of the container.
        networks:  # Connect the service to a specific network.
        - app-network  # Use the "app-network" network.
...
Tag the image:
```bash
docker tag llong1/backendtp llong1/backendtp:1.0
```

Push the image to dockerhub:
```bash
docker push llong1/backendtp:1.0 
```

We can see the image on dockerhub:
![image](https://github.com/lucielong/tpDevops/assets/107046732/7072191e-2415-4db1-91ef-1c1c85da9f7b)
...
We have all the images on Docker Hub:
![image](https://github.com/lucielong/tpDevops/assets/107046732/b1eb095e-acae-49d8-bc30-84590f4f8933)


### 2-3 Document your quality gate configuration.

First we have to create a SonarCloud account and generate an access token with appropriate permissions for integration with the GitHub repository:

![image](https://github.com/lucielong/tpDevops/assets/107046732/d8325265-0fc2-4b9e-a9ec-5727012f1b86)
...
We can see the result of the quality gate on the SonarCloud account:

![image](https://github.com/lucielong/tpDevops/assets/107046732/e3f3d323-3f15-4631-98f8-8d7847310508)
...
# It defines variables and host groups for Ansible playbooks.
...
```yaml
# Define the task name: Launch Front
- name: Launch Front
